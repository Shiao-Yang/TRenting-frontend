<template>
  <div class="about">
    <div id = "f-shortcut" class = "f-shortcut" style="position: fixed;top:0;">
    ...
    <div id="inner-content">
      ...
      <img :src=imgBase64_pre+imgBase64>
    </div>
  </div>
