            ...
            <el-tabs v-model="activeName" stretch="true" >
              <el-tab-pane label="全部报修" name="first">
                <el-table
                    ...
                    type="index"
                    width="100%">
                  <el-table-column align="center" prop="id" label="报修编号" >
                  </el-table-column>
                  <el-table-column align="center" prop="hid" label="房源编号" >
                  </el-table-column>
                  ...
                  <el-table-column align="center" label="操作" width="200">
                    <template v-slot="scope" >
                      <div v-if="scope.row.status !== 3">
                        <el-button type="danger" plain size="mini" slot="reference" @click="dialogVisible4=true; complainForm.tid = scope.row.id; complainForm.content = ''; complainForm.img='';">提交投诉</el-button>
                      </div>
                      <div v-else-if="scope.row.comment===null">
                        <el-button type="danger" plain size="mini" slot="reference" @click="dialogVisible4=true; complainForm.tid = scope.row.id; complainForm.content = ''; complainForm.img='';">提交投诉</el-button>
                        <el-divider direction="vertical"></el-divider>
                        <el-button type="primary" size="small" plain @click="dialogVisible3=true; commentForm.tid=scope.row.id; commentForm.info = ''; commentForm.comment=null;">评价师傅</el-button>
                      </div>
                      <div v-else>
                        <el-button type="danger" plain size="mini" slot="reference" @click="dialogVisible4=true; complainForm.tid = scope.row.id; complainForm.content = ''; complainForm.img='';">提交投诉</el-button>
                        <el-divider direction="vertical"></el-divider>
                        <el-popover placement="left" width="500" trigger="click">
                          <el-button type="success" size="small" plain slot="reference">查看评价</el-button>
                          <el-form ref="form" :model="scope.row" label-width="80px" size="mini">
                            <el-form-item label="我的打分:" prop="comment">
                              <el-rate
                                  style="margin-top: 5px"
                                  v-model="scope.row.comment"
                                  :disabled="scope.row.comment!==null"
                                  show-text>
                              </el-rate>
                            </el-form-item>
                            <el-form-item label="我的评价:" prop="details">
                              {{scope.row.details}}
                            </el-form-item>
                          </el-form>
                        </el-popover>
                    ...
                    <template v-slot="scope">
                      <el-popover placement="left" width="500" trigger="click">
                        ...
                        <el-card shadow="hover" :body-style= "{ padding:  '0px'}" width="100%">
                          ...
                          <el-card shadow="hover" :body-style= "{ padding:  '0px'}" width="100%">
                            <div slot="header" class="clearfix" style="font-size: 15px; height: 20px">报修工单</div>
                            <div style="padding: 14px;">
              ...
              <el-tab-pane label="待处理报修" name="second">
                <el-table
              ...
              <el-tab-pane label="正在处理报修" name="third">
                <el-table
                    :data="order_handling_paging"
                    align="center"
                    border
                    v-loading="this.loading"
                    type="index"
                ...
                <el-pagination
                    ...
                    :page-size="5"
                    :pager-count="7"
                    :current-page="current_page_handling"
                    layout="prev, pager, next"
                    @current-change = "order_handling_change_page"
                    :total="this.order_handling.length"
                    style="float:right">
                </el-pagination>
              </el-tab-pane>

              <el-tab-pane label="待评价报修" name="forth">
                <el-table
                    :data="order_uncommented_paging"
                    align="center"
                    border
                    v-loading="this.loading"
                    type="index"
                ...
                <el-pagination
                    ...
                    :page-size="5"
                    :pager-count="7"
                    :current-page="current_page_uncommented"
                    layout="prev, pager, next"
                    @current-change = "order_uncommented_change_page"
                    :total="this.order_uncommented.length"
                    style="float:right">
                </el-pagination>
              </el-tab-pane>


              <el-tab-pane label="已完成报修" name="fifth">
                <el-table
        ...
        if(res.data.errno === 0) {
          ...
          for(let i = 0; i < this.order_all.length; i++) {
            if(this.order_all[i].id === send_data.tid) {
              ...
              this.order_all[i].details = send_data.details;
              break;
            }
          ...
          for(let i = 0; i < this.order_all.length; i++) {
            ...
            if(this.order_all[i].status === 2) {
              this.order_handling.push(this.order_all[i]);
            }
